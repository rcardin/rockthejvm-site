...
```
18:12:29.596 [] INFO  in.rcard.sc.Main - Finding repositories for user with id 'UserId[value=1]'
18:12:29.596 [] INFO  in.rcard.sc.Main - Finding user with id 'UserId[value=2]'
18:12:29.596 [] INFO  in.rcard.sc.Main - Finding repositories for user with id 'UserId[value=2]'
18:12:29.596 [] INFO  in.rcard.sc.Main - Finding user with id 'UserId[value=1]'
18:12:30.108 [] INFO  in.rcard.sc.Main - User 'UserId[value=2]' found
18:12:30.109 [] INFO  in.rcard.sc.Main - User 'UserId[value=1]' found
18:12:30.608 [] INFO  in.rcard.sc.Main - Repositories found for user 'UserId[value=2]'
18:12:30.608 [] INFO  in.rcard.sc.Main - Repositories found for user 'UserId[value=1]'
```

As we can see, the executions of the two subtasks are interleaved, and the results are returned as a list of `GitHubUser` instances.
