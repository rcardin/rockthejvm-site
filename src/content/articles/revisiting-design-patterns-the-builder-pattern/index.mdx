...
public class Travel {
    ...
    public interface Builder {
        ...
        Builder withDepartureDate(LocalDate departureDate);
        Builder withReturnDate(LocalDate returnDate);
    ...
    public static class RoundTripTravelBuilder implements Builder {
        ...
        public Travel build() {
            ...
            if (returnDate == null || returnDate.isBefore(departureDate)) {
                throw new IllegalStateException("Return date is required and must be after departure date");
            }
            if (adults.isEmpty()) {
                throw new IllegalStateException("At least one adult is required");
            }
